...
final class AppPreferences: ObservableObject {
    ...
    private init() {
        ...
        self.wrapLines = defaults.bool(forKey: Keys.wrapLines)
        ...
        self.invisibleCharactersColor = defaults.string(forKey: Keys.invisibleCharactersColor) ?? "gray"
        self.showToolbarLabels = defaults.bool(forKey: Keys.showToolbarLabels)
        ...
        self.enablePredictiveCompletion = defaults.object(forKey: Keys.enablePredictiveCompletion) as? Bool ?? true
        ...
        // Undo history
        self.undoHistoryLimit = defaults.integer(forKey: Keys.undoHistoryLimit) == 0 ? 100 : defaults.integer(forKey: Keys.undoHistoryLimit)
        ...
        // Status bar
        self.showCharacterCount = defaults.bool(forKey: Keys.showCharacterCount)
        self.showWordCount = defaults.bool(forKey: Keys.showWordCount)

        // Current line highlight
        self.showCurrentLineHighlight = defaults.bool(forKey: Keys.showCurrentLineHighlight)
        self.currentLineHighlightColor = defaults.string(forKey: Keys.currentLineHighlightColor) ?? "lightgray"
        ...
        // Syntax coloring
        self.enableSyntaxColoring = defaults.object(forKey: Keys.enableSyntaxColoring) as? Bool ?? true

        // Script output
        self.verboseScriptOutput = defaults.object(forKey: Keys.verboseScriptOutput) as? Bool ?? false
    }
    ...
    func resetToDefaults() {
        ...
        enablePredictiveCompletion = true
        logSaveDirectory = ""
        tempScriptDirectory = ""
        ...
        currentLineHighlightColor = "lightgray"
        ...
        // Syntax coloring
        enableSyntaxColoring = true

        // Script output
        verboseScriptOutput = false
    }
